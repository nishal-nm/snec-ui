...
const ProgramCard = memo(
  ({ title, subtitle, description, imagePath, href }) => {
    return (
        ...
        <div className="relative z-10 border-2 border-[#004B97] bg-white shadow-lg flex flex-col w-full h-full rounded-tl-3xl rounded-br-3xl overflow-hidden">
          ...
          >
            ...
            <div className="mt-auto pt-4">
              <a
                href={href}
                className="inline-flex items-center text-blue-600 font-medium text-lg hover:text-blue-700 transition-colors group"
              >
                Know More
